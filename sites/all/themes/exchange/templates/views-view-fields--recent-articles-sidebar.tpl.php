 ...
 */
?>
<div class="article-mini-node clearfix">
  <div class="article-mini-image">
    <?php print $fields['field_article_image']->wrapper_prefix; ?>
      <?php print $fields['field_article_image']->label_html; ?>
      <?php print $fields['field_article_image']->content; ?>
    <?php print $fields['field_article_image']->wrapper_suffix; ?>
  </div>
  <div class="article-mini-entry">
